  ...
  while ($r=mysqli_fetch_array($sql)){
    ...
    echo "<div class='prod_box'>
          ...
          <div class='prod_details_tab'>
           ...
           $tombol        
             <a href='produk-$r[id_produk]-$r[produk_seo].html'><i class='fa fa-retweet'></i>selengkapnya</a>            
          </div> 
          </div>";
  }
}
...
elseif ($_GET['module']=='profilkami'){
  ...
  echo "
        ...
        <div class='row'>
        <div class='col-lg-12'>
        <div class='hero__text' align='center'><h2>Profil</h2></div><br>
    	  <div class='prod_box_big'>
        	<div class='top_prod_box_big'></div>
        <div class='center_prod_box_big'>            
...
elseif ($_GET['module']=='carabeli'){
  ...
  echo "
        ...
        <div class='row'>
        <div class='col-lg-12'>
        <div class='hero__text' align='center'><h2>Cara Pembelian</h2></div><br>
    	  <div class='prod_box_big'>
        	<div class='top_prod_box_big'></div>
        <div class='center_prod_box_big'>            
                 <div class='product_img_big' align='center'>
...
elseif ($_GET['module']=='semuaproduk'){
  ...
  <div class='row'>
  <div class='col-lg-12'>
  <div class='hero__text' align='center'><h2>Semua Produk</h2><br></div></div> <br>";
  // Tentukan berapa data yang akan ditampilkan per halaman (paging)
  $p      = new Paging2;
  $batas  = 12;
  $posisi = $p->cariPosisi($batas);
...
elseif ($_GET['module']=='keranjangbelanja'){
  ...
  if($ketemu < 1){
    ...
    <div class='row'>
    <div class='col-lg-12'>
    <div class='hero__text' align='center'><h2>Keranjang Belanja</h2></div><br>
          <div class='prod_box_big'>
        	<div class='top_prod_box_big'></div>
        <div class='center_prod_box_big'>            
          ...
          <table border=0 cellpadding=45% align=justify>
          <tbody>
          <tr bgcolor=#7fad39><th>No</th><th>Produk</th><th>Nama Produk</th><th>Berat(Kg)</th><th>Qty</th>
...
elseif ($_GET['module']=='hubungikami'){
  echo " 
        ...
        <div class='row'>
        <div class='col-lg-12'>
        <div class='hero__text' align='center'><h2>Hubungi Kami</h2></div> <br>
    	  <div class='prod_box_big'>
        	<div class='top_prod_box_big'></div>
        <div class='center_prod_box_big'>            
                 <div class='product_img_big' align='center'>
...
elseif ($_GET['module']=='downloadkatalog'){
  ...
  <div class='row'>
  <div class='col-lg-12'>
  <div class='hero__text' align='center'>
