  ...
  <div class="col-12">
              <div class="card card-info">
                <div class="card-header">
                  ...
                  <div>
                    <a href="pages/batal/pdf_toko.php?tanggal=<?= $tanggal; ?>&tanggal1=<?= $tanggal1; ?>" target='_blank'>
                      <button class="btn btn-warning">PDF</button>
                    </a>
                    <a href="pages/batal/excel.php?tanggal=<?= $tanggal; ?>&tanggal1=<?= $tanggal1; ?>" target='_blank'>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                              <div class="input-group-btn">
                                <a href="<?= $admin_url; ?>main.php?pages=batal&act=detailorder&id_order=<?= $o['id_orders']; ?>" class="btn btn-warning">Detail</i></a>
                                <a href="./pages/batal/invoice.php?id_order=<?= $o['id_orders']; ?>"  target='_blank'>
                                  <button class="btn btn-secondary">Cetak Invoice</button>
                                </a>
                              </div>
                            </td>
