...
<div class="col-12">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Daftar Nama Produk</h3><br><br>
                <div>
                ...
                <div class="card-tools">
                    <form method="POST" action="main.php?pages=produk&act=custom">
                ...
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                            include "../lib/config.php";
                            include "../lib/koneksi.php";
                            $query = mysqli_query($koneksi, "SELECT * FROM produk WHERE nama_produk LIKE '%$_POST[search]%' ORDER BY id_produk");
                            $i=1;
                            while($k=mysqli_fetch_array($query)){                              
                          ?>
                    <tr>
