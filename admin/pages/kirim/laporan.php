        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Laporan Order Kirim</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<div class="col-12">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Daftar Order Kirim</h3>
                <form method=POST action='<?= $admin_url; ?>main.php?pages=kirim&act=custom'>
              ...
              <div class="card-body p-0">
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                            $query = mysqli_query($koneksi, "SELECT id_orders,nama_lengkap,jam_order,DATE_FORMAT(tgl_order, '%d-%m-%Y') as tanggal FROM orders,kustomer WHERE orders.id_kustomer=kustomer.id_kustomer and orders.status_order='Kirim' ORDER BY id_orders");
                            $i=1;
  ...
  <div class="col-12">
              <div class="card card-info">
                <div class="card-header">
                  ...
                  <div>
                    <a href="pages/kirim/pdf_toko.php?tanggal=<?= $tanggal; ?>&tanggal1=<?= $tanggal1; ?>" target='_blank'>
                      <button class="btn btn-warning">PDF</button>
                    </a>
                    <a href="pages/kirim/excel.php?tanggal=<?= $tanggal; ?>&tanggal1=<?= $tanggal1; ?>" target='_blank'>
                ...
                <div class="card-body p-0">
                  <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php
                              $query = mysqli_query($koneksi, "SELECT id_orders,nama_lengkap,jam_order,DATE_FORMAT(tgl_order, '%d-%m-%Y') as tanggal FROM orders,kustomer WHERE orders.id_kustomer=kustomer.id_kustomer and orders.status_order='Kirim' and orders.tgl_order BETWEEN '$tanggal' AND '$tanggal1' ORDER BY id_orders");
                              $i=1;
                              while($o=mysqli_fetch_array($query)){                              
                            ?>
                      <tr>
