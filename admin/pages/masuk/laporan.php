...
<div class="col-12">
            <div class="card card-info">
              <div class="card-header">
                ...
                <form method=POST action='<?= $admin_url; ?>main.php?pages=masuk&act=custom'>
              ...
              <div class="card-body p-0">
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                            $query = mysqli_query($koneksi, "SELECT id_orders,nama_lengkap,jam_order,DATE_FORMAT(tgl_order, '%d-%m-%Y') as tanggal FROM orders,kustomer WHERE orders.id_kustomer=kustomer.id_kustomer ORDER BY id_orders");
                            $i=1;
              ...
              <div class="card card-info">
                ...
                <div class="card-body p-0">
                  <table id="example2" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php
                              $query = mysqli_query($koneksi, "SELECT id_orders,nama_lengkap,jam_order,DATE_FORMAT(tgl_order, '%d-%m-%Y') as tanggal FROM orders,kustomer WHERE orders.id_kustomer=kustomer.id_kustomer and orders.tgl_order BETWEEN '$tanggal' AND '$tanggal1' ORDER BY id_orders");
                              $i=1;
                              while($o=mysqli_fetch_array($query)){                              
                            ?>
                      <tr>
